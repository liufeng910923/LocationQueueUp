...
public class InsertMyAttentionUtility extends AsyncTask<String, String, Integer> {
	private String memberId;
	private String companyId;

	public InsertMyAttentionUtility(String memberId,String companyId ) {
	...
	protected void onPostExecute(Integer result) {
		if(result==1){
			Toast.makeText(DetailInfoActivity.instance, "关注成功", 3000).show();
			DetailInfoActivity.instance.focus_btn.setText("取消关注");
			DetailInfoActivity.instance.img_focus.setBackgroundResource(R.drawable.qxguanzhutb);
			DetailInfoActivity.instance.attention = "true";
		}else{
			Toast.makeText(DetailInfoActivity.instance, "关注失败", 3000).show();
